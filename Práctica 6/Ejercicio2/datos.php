...
<?php
    ...
    //CODIGO PARA AÑADIR CIUDADES

    if(isset($_POST['addButton'])){             
        // Muestro un formulario a completar
        echo "<div class='createForm' >             
                ...
                <form action='datos.php' method='post'>
                    ...
                    <a href='./escritorio.php' class='secondaryButton'>Cancelar</a>
                    <button type='submit' class='primaryButton' name='createRow'>Aceptar</button>
                </form>
            </div>";
        }

    if(isset($_POST['createRow'])){        /// Traigo todos los datos nuevos 
        $ciudad = $_POST['ciudad'];
        $pais = $_POST['pais'];
        ...
        if($conn->query($query) or die($conn->error)){
            echo                           // Muestro mensaje de éxito
                "<div class='msg'>". 
                "<p>Ciudad agregada correctamente</p>".
                "<a href='./escritorio.php' class='primaryButton'>Volver</a>".
                "</div>";
        } else {
            echo                            // Muestro mensaje de fracaso
                "<div class='msg'>". 
    ...
    if(isset($_POST['deleteButton'])){
        if(isset($_POST['group'])){
            ...
            echo                            
                "<div class='msg'>
                    <form action='datos.php' method='post'>
                        <p>Seguro que desea eliminar esta ciudad?</p>
            ...
            echo                       
                "<div class='msg'>". 
                "<p>Seleccione un elemento por favor</p>".
                "<a href='./escritorio.php' class='primaryButton'>Volver</a>".
                "</div>";
        }
    }
    ...
    if(isset($_POST['deleteRow'])){
        ...
        mysqli_select_db($conn, $db);
        $id = $_POST['id'];
        $query = "DELETE FROM ciudades WHERE id=".$id."";       //Elimino ciudad elegida
        if($conn->query($query) or die($conn->error)){
            echo                        //Muestro mensaje de eliminación exitosa
                "<div class='msg'>". 
                "<p>Ciudad eliminada correctamente.</p>".
                "<a href='./escritorio.php' class='primaryButton'>Volver</a>".
                "</div>";
        } else {
            echo                        //Muestro mensaje que no se pudo realizar la eliminación
                "<div class='msg'>". 
